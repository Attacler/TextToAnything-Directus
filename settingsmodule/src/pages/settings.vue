...
onMounted(async () => {
    ...
    virusscannerMode.value =
        settings.data.data.TTA_VIRUSSCANNER_MODE || "delete";
});
            ...
            <v-card class="w-full">
                ...
                <v-card-text class="fields-spacing">
                    <div>
                        ...
                        <passwordField v-model="rapidKey" />
                    </div>
                </v-card-text>
                <v-card-text class="fields-spacing">
                    <v-button
                ...
                <v-card-text class="fields-spacing">
                    <div>
                        <span class="field-name"
                            >RapidAPI virusscanner token</span
                        >

                        <passwordField v-model="rapidKeyVirus" />
                    </div>
                </v-card-text>
                <v-card-text class="fields-spacing">
                    <v-button
                            ...
                            <v-hover>
                                <template #default="{ hover }">
                                    ...
                                    <VNotice v-if="hover" class="info-popup">
                                        <div>
                                            What should happen when a virus is
                                            detected?
                                            <ul>
                                                <li>
                                                    Delete threads, threads will
                                                    be deleted immediately
                                                </li>
                                                <li>
                                                    Trigger flow, the selected
                                                    flow will be triggered with
                                                    upload payload
                                                </li>
                                            </ul>

                                            <div>
                                                The trigger flow option is ideal
                                                for when you want to send a
                                                notification or add extra logic.
                                                The trigger flow option will not
                                                automaticly delete the file.
                                            </div>
                                        </div>
                                    </VNotice>
                                </template>
                        ...
                        <div class="field-name info-parent">
                            ...
                            <v-hover>
                                <template #default="{ hover }">
                                    <VIcon name="info" />
                                    <VNotice v-if="hover" class="info-popup">
                                        This flow will be triggered once a virus
                                        has been detected.
                                    </VNotice>
                                </template>
                            </v-hover>
